...
#define ENCODER_PHASE_A  PA0    // pin #2,3 are only things for using interrupt
...
#define HX711_SCK_1      PA3   //mcu > HX711 no 1 sck pin
#define HX711_DOUT_2     PA4   //mcu > HX711 no 2 dout pin
#define HX711_SCK_2      PA5   //mcu > HX711 no 2 sck pin
#define HX711_DOUT_3     PA6  //mcu > HX711 no 3 dout pin
#define HX711_SCK_3      PA7  //mcu > HX711 no 3 sck pin
