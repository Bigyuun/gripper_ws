...
//pins:
//const int HX711_dout_1 = PA5; //mcu > HX711 no 1 dout pin
//const int HX711_sck_1 = PA6; //mcu > HX711 no 1 sck pin
//const int HX711_dout_2 = PB3; //mcu > HX711 no 2 dout pin
//const int HX711_sck_2 = PB4; //mcu > HX711 no 2 sck pin
//const int HX711_dout_3 = PB0; //mcu > HX711 no 3 dout pin
//const int HX711_sck_3 = PB1; //mcu > HX711 no 3 sck pin

const int HX711_dout_1 = PA2; //mcu > HX711 no 1 dout pin
const int HX711_sck_1 = PA3; //mcu > HX711 no 1 sck pin
const int HX711_dout_2 = PA11; //mcu > HX711 no 2 dout pin
const int HX711_sck_2 = PA12; //mcu > HX711 no 2 sck pin
const int HX711_dout_3 = PA5; //mcu > HX711 no 3 dout pin
const int HX711_sck_3 = PA6; //mcu > HX711 no 3 sck pin
